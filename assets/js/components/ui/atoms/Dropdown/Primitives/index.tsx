  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        'hover:bg-muted focus:bg-accent dark:hover:bg-background',
        'data-[variant=destructive]:dark:bg-destructive',
        className,
      )}
      {...props}
    />
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn({
        'px-2 py-1.5': padding === 'normal',
        'data-[inset]:pl-8': padding !== 'none',
      })}
      {...props}
    >
