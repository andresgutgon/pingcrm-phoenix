    ...
    <Tooltip
      ...
      trigger={
        <Button
          variant='ghost'
          size='icon'
          iconProps={{ name: 'panelLeftIcon' }}
          data-sidebar='trigger'
          data-slot='sidebar-trigger'
          className={cn('size-7', className)}
          screenReaderText='Toggle Sidebar'
          onClick={(event) => {
            onClick?.(event)
            toggleSidebar()
          }}
...
function SidebarRail({ className, ...props }: ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        'hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 ease-linear',
...
function SidebarGroupLabel({ label }: { label: string }) {
  return (
    ...
    >
      <Text.H6M color='sidebar' textOpacity='70'>
        {label}
      </Text.H6M>
    </div>
  )
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        "hover:[&>[data-text-atom='true']]:text-sidebar-accent-foreground",
        "hover:[&>[data-icon-atom='true']]:text-sidebar-accent-foreground",
        "data-[active=true]:[&>[data-text-atom='true']]:text-white",
        "data-[active=true]:[&>[data-icon-atom='true']]:text-white",
        "hover:[&>[data-text-atom='true']]:text-sidebar-accent-foreground",
        "hover:[&>[data-icon-atom='true']]:text-sidebar-accent-foreground",
      )}
      {...props}
